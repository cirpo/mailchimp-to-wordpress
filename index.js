...
request(mailchimpOpts, function (error, response, jscode) {
    ...
    if (!error && response.statusCode == 200) {
        ...
        // unfortunately wordpress limits the number of posts per request to 100 so we have to use a workaround
        for(var page = 1; page < 10; page++) {
            ...
            var prom = requestp({
                ...
                .then(function (response) {
                    // store already saved issues/posts using the 'mailchimp_id' meta as identifier
            ...
            postsProms.push(prom);

        }

        q.all(postsProms).then(function(){
